...
\begin{enumerate}
  ...
  data from other sources \cite{TheRoyalGeographicalSociety1897}, popustat.
...
The notable results of this work are:
\begin{enumerate}
  \item Regions in which developing countries predominate (SE Asia, Africa, W. Asia)
  have expanded their use of muscle work, just as more developed regions have
  turned to other fuel types.
  \item The decline in use of horses as work animals caused 2015
  to be the first year in which
  humans were doing as much muscle work as animals.
  \item Human muscle work (HMW) and animal muscle work (AMW) growth rates 
  are not necessarily coupled. 
  \item HMW efficiency has decreased 30-50\% in the developed regions of 
  Europe and North America, 
  whereas it has decreased less than 10\% in other world regions.
\end{enumerate}
...
%++++++++++++++++++++++++++++++
The final to useful muscle work of animals did not change over time,
as it was assumed that they did the same amount of work,
and ate the same amount of food every year that was studied.

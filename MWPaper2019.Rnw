...
Appendix \ref{App1} lists other sources
...
For the world total, the total muscle work from each region was added together,
as in the equation
...
using the lowest of the range of energy expenditures for "light activity" (non-working days)
and the lowest of the "very active" and "moderately active" energy expenditure values
for primary and secondary workers respectively FAOWHO1973. 
